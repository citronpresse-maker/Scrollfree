      ...
      >
        <div className="relative z-10 w-full mb-10 text-center">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-medium tracking-tight text-white mb-6 max-w-4xl mx-auto uppercase">
             LA BOUCLE <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-[#F4D3A1] to-[#D4A373]">PSYCHOLOGIQUE</span>
          </h2>
        ...
        <div className="relative w-full max-w-[650px] aspect-square mx-auto mt-4 mb-20 hidden sm:block">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 flex items-center justify-center overflow-visible z-10 pointer-events-none">
             ...
             >
               <img src={vortexImage} alt="Vortex" loading="lazy" decoding="async" width="400" height="400" className="w-[105%] h-[105%] max-w-none object-contain pointer-events-none drop-shadow-[0_0_20px_rgba(249,115,22,0.3)]" />
             </m.div>
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none overflow-visible z-0" viewBox="0 0 500 500">
             <defs>
               <linearGradient id="grad-v1" x1="0%" y1="100%" x2="100%" y2="0%">
                 <stop offset="0%" stopColor="#F4D3A1" stopOpacity="0.3" />
               ...
               <marker id="head-v1" viewBox="0 0 10 10" refX="0" refY="5" markerWidth="5" markerHeight="5" orient="auto">
                 <path d="M 0 0 L 10 5 L 0 10 z" fill="#D4A373" fillOpacity="0.85"/>
               </marker>
          ...
          <div className="absolute z-30 flex items-center justify-center" style={{ left: "50%", top: "20%", transform: "translate(-50%, -50%)" }}>
             <div className="relative flex items-center justify-center w-16 h-16">
               <div className="z-10 bg-[#0B0F19] rounded-full text-transparent border border-transparent flex items-center justify-center">
                 <GradientIcon paths={["M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9", "M10.3 21a1.94 1.94 0 0 0 3.4 0"]} size={48} strokeWidth="2.5" />
               </div>
               <div className="absolute bottom-full mb-6 left-1/2 -translate-x-1/2 bg-[#121620] py-3.5 px-6 rounded-2xl border border-white/5 w-max flex flex-col items-center text-center shadow-2xl">
                  <h4 className="text-white text-[13px] md:text-[15px] font-bold uppercase tracking-widest mb-1.5">Déclencheur</h4>
                  <p className="text-white/90 text-[13px] md:text-[15px] leading-tight font-light max-w-[220px]">Une notification ou un moment d'ennui active un réflexe automatique d'ouverture.</p>
               </div>
             </div>
          </div>
          ...
          <div className="absolute z-30 flex items-center justify-center" style={{ left: "78.4%", top: "40.6%", transform: "translate(-50%, -50%)" }}>
             <div className="relative flex items-center justify-center w-16 h-16">
               ...
               <div className="absolute left-full ml-6 top-1/2 -translate-y-1/2 bg-[#121620] py-3.5 px-6 rounded-2xl border border-white/5 w-max flex flex-col items-start text-left shadow-2xl">
                  <h4 className="text-white text-[13px] md:text-[15px] font-bold uppercase tracking-widest mb-1.5">Scroll</h4>
                  <p className="text-white/70 text-[13px] md:text-[15px] leading-tight font-light max-w-[240px]">Ton attention s'engouffre dans un flux infini, à la recherche d'une récompense variable.</p>
               </div>
             </div>
          </div>
          ...
          <div className="absolute z-30 flex items-center justify-center" style={{ left: "67.6%", top: "74.2%", transform: "translate(-50%, -50%)" }}>
             <div className="relative flex items-center justify-center w-16 h-16">
               <div className="z-10 bg-[#0B0F19] rounded-full border border-transparent flex items-center justify-center -ml-1.5 -mt-1.5">
                 <CustomBrain size={60} />
               </div>
               <div className="absolute left-full ml-6 top-1/2 -translate-y-1/2 bg-[#121620] py-3.5 px-6 rounded-2xl border border-white/5 w-max flex flex-col items-start text-left shadow-2xl">
                  <h4 className="text-white text-[13px] md:text-[15px] font-bold uppercase tracking-widest mb-1.5">Dopamine</h4>
                  <p className="text-white/70 text-[13px] md:text-[15px] leading-tight font-light max-w-[240px]">Ton cerveau libère une micro-dose de plaisir qui anesthésie instantanément l'effort.</p>
               </div>
             </div>
          </div>
          ...
          <div className="absolute z-30 flex items-center justify-center" style={{ left: "32.4%", top: "74.2%", transform: "translate(-50%, -50%)" }}>
             <div className="relative flex items-center justify-center w-16 h-16">
               ...
               <div className="absolute right-full mr-6 top-1/2 -translate-y-1/2 bg-[#121620] py-3.5 px-6 rounded-2xl border border-white/5 w-max flex flex-col items-start text-left shadow-2xl">
                  <h4 className="text-white text-[13px] md:text-[15px] font-bold uppercase tracking-widest mb-1.5">Chute</h4>
                  <p className="text-white/70 text-[13px] md:text-[15px] leading-tight font-light max-w-[240px]">L'excitation retombe, laissant place à une fatigue mentale et un sentiment de vide.</p>
               </div>
             </div>
          </div>
          ...
          <div className="absolute z-30 flex items-center justify-center" style={{ left: "21.6%", top: "40.6%", transform: "translate(-50%, -50%)" }}>
             <div className="relative flex items-center justify-center w-16 h-16">
               <div className="z-10 bg-[#0B0F19] text-transparent rounded-full border border-transparent flex items-center justify-center">
               ...
               <div className="absolute right-full mr-6 top-1/2 -translate-y-1/2 bg-[#121620] py-3.5 px-6 rounded-2xl border border-white/5 w-max flex flex-col items-start text-left shadow-2xl">
                  ...
                  <p className="text-white/70 text-[13px] md:text-[15px] leading-tight font-light max-w-[240px]">Le circuit se renforce, transformant l'impulsion en un besoin vital et inconscient.</p>
               </div>
             </div>
          </div>
        </div>
        ...
        <div className="sm:hidden w-full flex flex-col space-y-6 mt-8 mb-4">
           <div className="flex flex-col items-center text-center">
              ...
              <p className="text-white/80 text-[9px] leading-snug max-w-[180px]">Une notification ou un moment d'ennui active un réflexe automatique d'ouverture.</p>
           </div>
           ...
           <div className="flex flex-col items-center text-center">
              ...
              <p className="text-white/80 text-[9px] leading-snug max-w-[180px]">Ton attention s'engouffre dans un flux infini, à la recherche d'une récompense variable.</p>
           </div>
           ...
           <div className="flex flex-col items-center text-center">
              ...
              <p className="text-white/80 text-[9px] leading-snug max-w-[180px]">Ton cerveau libère une micro-dose de plaisir qui anesthésie instantanément l'effort.</p>
           </div>
           ...
           <div className="flex flex-col items-center text-center">
              ...
              <p className="text-white/80 text-[9px] leading-snug max-w-[180px]">L'excitation retombe, laissant place à une fatigue mentale et un sentiment de vide.</p>
           </div>
           ...
           <div className="flex flex-col items-center text-center">
              ...
              <p className="text-white/80 text-[9px] leading-snug max-w-[180px]">Le circuit se renforce, transformant l'impulsion en un besoin vital et inconscient.</p>
           </div>
        </div>
      </m.div>
    </section>
