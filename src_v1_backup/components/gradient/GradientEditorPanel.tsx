...
export const GradientEditorPanel: React.FC<GradientEditorPanelProps> = ({
  ...
  return (
    <aside 
      className={`fixed right-4 top-4 z-[100] h-[calc(100vh-32px)] w-[400px] overflow-y-auto rounded-[24px] border border-white/10 bg-[#0D1117]/95 p-6 text-[11px] shadow-2xl backdrop-blur-2xl text-white scrollbar-hide transition-all duration-300 ${isOpen ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10 pointer-events-none'}`}
    >
      {/* HEADER */}
