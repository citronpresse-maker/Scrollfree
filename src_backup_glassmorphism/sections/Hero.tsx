      ...
      <nav id="navbar" className="relative z-50 px-6 py-12 md:px-12 flex justify-between items-center max-w-7xl mx-auto">
          ...
          <div className="relative group flex items-center justify-center">
            ...
            <svg className="h-[80px] md:h-[120px] w-auto text-white relative z-10 -ml-2 -my-8 md:-my-12 pointer-events-none" viewBox="0 0 1120 760" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Scrollfree wordmark">
              ...
              <g transform="translate(0 300)">
                <g fill="#f8f8f8" opacity="0.98" fontFamily="Helvetica Neue, Helvetica, Arial, sans-serif" fontWeight="300" fontSize="58" letterSpacing="0">
                ...
                <g stroke="#f8f8f8" strokeWidth="5.2" strokeLinecap="round" opacity="0.98">
        ...
        {isMenuOpen && (
          <m.div 
            ...
            className="absolute top-24 left-0 w-full bg-black/95 backdrop-blur-sm border-b border-white/10 px-6 py-8 flex flex-col gap-6 md:hidden z-50 text-center"
          >
            {navLinks.map((link) => (
              <a
                key={link.name}
