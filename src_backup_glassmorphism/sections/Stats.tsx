      ...
      >
        {stats.map((stat, i) => (
          <m.div
            ...
            className="relative border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] rounded-[32px] p-7 lg:p-8 flex flex-col items-start hover:border-white/40 hover:-translate-y-2 hover:shadow-[0_16px_40px_0_rgba(0,0,0,0.6)] transition-all duration-500 overflow-hidden group bg-white/[0.02] backdrop-blur-sm"
          >
